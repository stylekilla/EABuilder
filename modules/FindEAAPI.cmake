...
# Find the headers.
find_path(EAAPI_INCLUDE_DIR EAAPI/Servant.h HINTS C:/EAAPI PATH_SUFFIXES include)
set(EAAPI_INCLUDE_DIRS ${EAAPI_INCLUDE_DIR})
...
set(EAAPI_LIBRARIES optimized ${EAAPI_LIBRARY} ${VAAPI_LIBRARY} Rpcrt4.lib
                    debug     ${EAAPI_DEBUG_LIBRARY} ${VAAPI_DEBUG_LIBRARY} Rpcrt4.lib)
...
find_package_handle_standard_args(EAAPI DEFAULT_MSG EAAPI_LIBRARY VAAPI_LIBRARY EAAPI_INCLUDE_DIR)
